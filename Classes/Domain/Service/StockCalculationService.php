 ...
 */
class Tx_HypeStore_Domain_Service_StockCalculationService implements t3lib_singleton {
	
	public function getStockQuantity(Tx_HypeStore_Domain_Model_Product $product) {
	...
	public function hasStock(Tx_HypeStore_Domain_Model_Product $product) {
